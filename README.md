...
- **[@rrweb/serverside-replay](https://github.com/rrweb-io/rrweb/tree/master/packages/serverside-replay/)**, generates static DOM snapshots (HTML + metadata) from rrweb recordings at specified timestamps in Node.js — no browser required. Useful for server-side rendering of recorded sessions, generating thumbnails, or extracting page state at a point in time.
